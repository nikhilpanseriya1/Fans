...
class CountryCodePickerScreen extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return CountryCodePickerScreenState(elements);
  }
}

class CountryCodePickerScreenState extends State<CountryCodePickerScreen> {
  CountryCode? selectedItem;
  List<CountryCode> elements = [];
  List<CountryCode> favoriteElements = [];

  CountryCodePickerScreenState(this.elements);
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.builder != null) {
      ...
      _widget = widget.builder!(selectedItem);
    } else {
      _widget = TextButton(
  ...
  @override
  void didUpdateWidget(CountryCodePickerScreen oldWidget) {
  ...
  void initState() {
    ...
    favoriteElements = elements
        .where((e) =>
            widget.favorite.firstWhereOrNull((f) => e.code!.toUpperCase() == f.toUpperCase() || e.dialCode == f || e.name!.toUpperCase() == f.toUpperCase()) !=
            null)
        .toList();
  }
          ...
          child: Container(
            ...
            child: Dialog(
              child: SelectionDialog(
                ...
                size: Size(getScreenWidth(context) - 40, getScreenHeight(context) * 0.70)/*widget.dialogSize*/,
