...
class FontStyleUtility{
  ...
  static TextStyle blackInter18W600 = const TextStyle(color: colorSemiDarkBlack, fontSize: 18, fontFamily: 'Inter', fontWeight: FontWeight.w600);
  static TextStyle blackInter20W600 = const TextStyle(color: colorSemiDarkBlack, fontSize: 20, fontFamily: 'Inter', fontWeight: FontWeight.w600);
  static TextStyle blackInter16W700 = const TextStyle(color: colorSemiDarkBlack, fontSize: 16, fontFamily: 'Inter', fontWeight: FontWeight.w700);
  static TextStyle blackInter18W700 = const TextStyle(color: colorSemiDarkBlack, fontSize: 18, fontFamily: 'Inter', fontWeight: FontWeight.w700);
  static TextStyle blackInter18W500 = const TextStyle(color: colorSemiDarkBlack, fontSize: 18, fontFamily: 'Inter', fontWeight: FontWeight.w500);
  static TextStyle blackInter20W500 = const TextStyle(color: colorSemiDarkBlack, fontSize: 20, fontFamily: 'Inter', fontWeight: FontWeight.w500);
  static TextStyle blackInter15W500 = const TextStyle(color: colorSemiDarkBlack, fontSize: 15, fontFamily: 'Inter', fontWeight: FontWeight.w500);
  static TextStyle blackInter14W600 = const TextStyle(color: colorSemiDarkBlack, fontSize: 14, fontFamily: 'Inter', fontWeight: FontWeight.w600);
  static TextStyle blackInter14W500 = const TextStyle(color: colorSemiDarkBlack, fontSize: 14, fontFamily: 'Inter', fontWeight: FontWeight.w500);
  static TextStyle blackInter14W400 = const TextStyle(color: colorSemiDarkBlack, fontSize: 14, fontFamily: 'Inter', fontWeight: FontWeight.w400);
  ...
  static TextStyle blackSansSerif18W500 = const TextStyle(color: colorSemiDarkBlack, fontSize: 16, fontFamily: 'sans-serif', fontWeight: FontWeight.w400);


  ///grey text
  static TextStyle greyInter16W500 = const TextStyle(color: colorGrey, fontSize: 16, fontFamily: 'Inter', fontWeight: FontWeight.w500);
  static TextStyle greyInter18W500 = const TextStyle(color: colorGrey, fontSize: 18, fontFamily: 'Inter', fontWeight: FontWeight.w500);
  ...
  static TextStyle greyInter12W500 = const TextStyle(color: colorGrey, fontSize: 12, fontFamily: 'Inter', fontWeight: FontWeight.w500);
  ...
  static TextStyle greyInter22W500 = const TextStyle(color: colorGrey, fontSize: 20, fontFamily: 'Inter', fontWeight: FontWeight.w500);
  ///grey text
  ...
  ///===================================   DMSans   ===============================
  ///black text
  static TextStyle blackDMSerifDisplay16W500 = const TextStyle(color: colorSemiDarkBlack, fontSize: 16, fontFamily: 'DMSerifDisplay', fontWeight: FontWeight.w500);
  static TextStyle blackDMSerifDisplay18W400 = const TextStyle(color: colorSemiDarkBlack, fontSize: 18, fontFamily: 'DMSerifDisplay', fontWeight: FontWeight.w400);
  static TextStyle blackDMSerifDisplay14W500 = const TextStyle(color: colorSemiDarkBlack, fontSize: 14, fontFamily: 'DMSerifDisplay', fontWeight: FontWeight.w500);
  static TextStyle blackDMSerifDisplay22W400 = const TextStyle(color: colorSemiDarkBlack, fontSize: 22, fontFamily: 'DMSerifDisplay', fontWeight: FontWeight.w400);
  static TextStyle blackDMSerifDisplay24W400 = const TextStyle(color: colorSemiDarkBlack, fontSize: 24, fontFamily: 'DMSerifDisplay', fontWeight: FontWeight.w400);
  static TextStyle blackDMSerifDisplay26W400 = const TextStyle(color: colorSemiDarkBlack, fontSize: 26, fontFamily: 'DMSerifDisplay', fontWeight: FontWeight.w400);
  static TextStyle blackDMSerifDisplay20W400 = const TextStyle(color: colorSemiDarkBlack, fontSize: 20, fontFamily: 'DMSerifDisplay', fontWeight: FontWeight.w400);
  static TextStyle blackDMSerifDisplay24W700 = const TextStyle(color: colorSemiDarkBlack, fontSize: 24, fontFamily: 'DMSerifDisplay', fontWeight: FontWeight.w700);
  static TextStyle blackDMSerifDisplay26W700 = const TextStyle(color: colorSemiDarkBlack, fontSize: 26, fontFamily: 'DMSerifDisplay', fontWeight: FontWeight.w700);
  static TextStyle blackDMSerifDisplay24W800 = const TextStyle(color: colorSemiDarkBlack, fontSize: 24, fontFamily: 'DMSerifDisplay', fontWeight: FontWeight.w800);
  static TextStyle blackDMSerifDisplay16W600 = const TextStyle(color: colorSemiDarkBlack, fontSize: 16, fontFamily: 'DMSerifDisplay', fontWeight: FontWeight.w600);



  ///grey text
  static TextStyle greyDMSerifDisplay16W500 = const TextStyle(color: colorGrey, fontSize: 16, fontFamily: 'DMSerifDisplay', fontWeight: FontWeight.w500);
